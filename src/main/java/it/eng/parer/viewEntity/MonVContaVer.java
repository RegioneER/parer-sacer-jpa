...
/**
 * The persistent class for the MON_V_CONTA_VERS database table.
 * 
 */
@Entity
@Table(name = "MON_V_CONTA_VERS")
@NamedQuery(name = "MonVContaVer.findAll", query = "SELECT m FROM MonVContaVer m")
public class MonVContaVer implements Serializable {
