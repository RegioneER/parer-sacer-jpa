...
@Embeddable()
public class MonVContaAggId implements Serializable {

    @Override
    public int hashCode() {
        int hash = 3;
        hash = 31 * hash + Objects.hashCode(this.aaKeyUnitaDoc);
        hash = 31 * hash + Objects.hashCode(this.dtRifConta);
        hash = 31 * hash + Objects.hashCode(this.idRegistroUnitaDoc);
        hash = 31 * hash + Objects.hashCode(this.idStrut);
        hash = 31 * hash + Objects.hashCode(this.idSubStrut);
        hash = 31 * hash + Objects.hashCode(this.idTipoDocPrincipale);
        hash = 31 * hash + Objects.hashCode(this.idTipoUnitaDoc);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final MonVContaAggId other = (MonVContaAggId) obj;
