...
/**
 * The persistent class for the MON_V_LIS_UD_VERS database table.
 *
 */
@Entity
@Table(name = "MON_V_LIS_UD_VERS")
@NamedQuery(name = "MonVLisUdVers.findAll", query = "SELECT m FROM MonVLisUdVers m")
public class MonVLisUdVers implements Serializable {
    ...
    public MonVLisUdVers() {/* Hibernate */
    }
