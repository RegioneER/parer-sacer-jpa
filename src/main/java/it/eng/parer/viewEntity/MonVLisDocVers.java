...
/**
 * The persistent class for the MON_V_LIS_DOC_VERS database table.
 *
 */
@Entity
@Table(name = "MON_V_LIS_DOC_VERS")
@NamedQuery(name = "MonVLisDocVers.findAll", query = "SELECT m FROM MonVLisDocVers m")
public class MonVLisDocVers implements Serializable {
    ...
    public MonVLisDocVers() {/* Hibernate */
    }
