...
/**
 * The persistent class for the DEC_V_CREA_CRIT_RAGGR_REGISTRO database table.
 *
 */
@Entity
@Table(name = "DEC_V_CREA_CRIT_RAGGR_REGISTRO")
@NamedQuery(name = "DecVCreaCritRaggrRegistro.findAll", query = "SELECT d FROM DecVCreaCritRaggrRegistro d")
public class DecVCreaCritRaggrRegistro implements Serializable {
    ...
    public DecVCreaCritRaggrRegistro() {/* Hibernate */
    }
