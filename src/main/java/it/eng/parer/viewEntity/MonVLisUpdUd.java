...
/**
 * The persistent class for the MON_V_LIS_UPD_UD database table.
 *
 */
@Entity
@Table(name = "MON_V_LIS_UPD_UD")
@NamedQuery(name = "MonVLisUpdUd.findAll", query = "SELECT m FROM MonVLisUpdUd m")
public class MonVLisUpdUd implements MonVLisUpdUdInterface {
