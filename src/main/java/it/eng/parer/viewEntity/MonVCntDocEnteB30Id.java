...
@Embeddable()
public class MonVCntDocEnteB30Id implements Serializable {

    @Override
    public int hashCode() {
        int hash = 3;
        hash = 17 * hash + Objects.hashCode(this.idEnte);
    ...
    public boolean equals(Object obj) {
        ...
        final MonVCntDocEnteB30Id other = (MonVCntDocEnteB30Id) obj;
