...
@NamedQuery(name = "MonVChkFascByStrut.findByStrutUser", query = "SELECT m FROM MonVChkFascByStrut m WHERE m.idStrut = :idStrut AND m.idUserIam=:idUserIam")
