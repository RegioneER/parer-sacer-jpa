...
/**
 * The persistent class for the ORG_V_CHK_TIME_PARTITION_FASC database table.
 *
 */
@Entity
@Table(name = "ORG_V_CHK_TIME_PARTITION_FASC")
@NamedQuery(name = "OrgVChkTimePartitionFasc.findAll", query = "SELECT o FROM OrgVChkTimePartitionFasc o")
public class OrgVChkTimePartitionFasc implements Serializable {
    ...
    public OrgVChkTimePartitionFasc() {/* Hibernate */
    }
