...
/**
 * The persistent class for the MON_V_LIS_DOC_IAM database table.
 *
 */
@Entity
@Table(name = "MON_V_LIS_DOC_IAM")
@NamedQuery(name = "MonVLisDocIam.findAll", query = "SELECT m FROM MonVLisDocIam m")
public class MonVLisDocIam implements Serializable {
    ...
    public MonVLisDocIam() {/* Hibernate */
    }
