...
/**
 * The persistent class for the MON_V_LIS_UD_VERS_DA_ELAB database table.
 *
 */
@Entity
@Table(name = "MON_V_LIS_UD_VERS_DA_ELAB")
@NamedQuery(name = "MonVLisUdVersDaElab.findAll", query = "SELECT m FROM MonVLisUdVersDaElab m")
public class MonVLisUdVersDaElab implements Serializable {
    ...
    public MonVLisUdVersDaElab() {/* Hibernate */
    }
