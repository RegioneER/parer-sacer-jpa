...
/**
 * The persistent class for the MON_V_CONTA_VERS_ANNUL database table.
 * 
 */
@Entity
@Table(name = "MON_V_CONTA_VERS_ANNUL")
@NamedQuery(name = "MonVContaVersAnnul.findAll", query = "SELECT m FROM MonVContaVersAnnul m")
public class MonVContaVersAnnul implements Serializable {
