 ...
 */
@Entity
@Table(name = "LOG_V_LIS_SCHED_HIST")
public class LogVLisSchedHist implements Serializable {
    ...
    public LogVLisSchedHist() {/* Hibernate */
    }

    public LogVLisSchedHist(Date dtRegLogJobIni, Date dtRegLogJobFine, BigDecimal durataGg, BigDecimal durataOre,
