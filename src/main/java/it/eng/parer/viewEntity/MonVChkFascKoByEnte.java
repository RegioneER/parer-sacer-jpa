...
@NamedQuery(name = "MonVChkFascKoByEnte.findByEnteUser", query = "SELECT m FROM MonVChkFascKoByEnte m WHERE m.idEnte = :idEnte AND m.idUserIam = :idUser")
