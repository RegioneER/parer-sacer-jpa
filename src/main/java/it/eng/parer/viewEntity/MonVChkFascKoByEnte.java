...
/**
 * The persistent class for the MON_V_CHK_FASC_KO_BY_ENTE database table.
 */
@Entity
@Table(name = "MON_V_CHK_FASC_KO_BY_ENTE")
@NamedQuery(name = "MonVChkFascKoByEnte.findByEnteUser", query = "SELECT m FROM MonVChkFascKoByEnte m WHERE m.monVChkFascKoByEnteId.idEnte = :idEnte AND m.monVChkFascKoByEnteId.idUserIam = :idUser")
public class MonVChkFascKoByEnte implements Serializable {
    ...
    public MonVChkFascKoByEnte() {/* Hibernate */
    }
    ...
    private MonVChkFascKoByEnteId monVChkFascKoByEnteId;

    @EmbeddedId()
    public MonVChkFascKoByEnteId getMonVChkFascKoByEnteId() {
        return monVChkFascKoByEnteId;
    }

    public void setMonVChkFascKoByEnteId(MonVChkFascKoByEnteId monVChkFascKoByEnteId) {
        this.monVChkFascKoByEnteId = monVChkFascKoByEnteId;
    }
}
