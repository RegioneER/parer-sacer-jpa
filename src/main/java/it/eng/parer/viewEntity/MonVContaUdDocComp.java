...
/**
 * The persistent class for the MON_V_CONTA_UD_DOC_COMP database table.
 *
 */
@Entity
@Table(name = "MON_V_CONTA_UD_DOC_COMP")
@NamedQuery(name = "MonVContaUdDocComp.findAll", query = "SELECT m FROM MonVContaUdDocComp m")
public class MonVContaUdDocComp implements Serializable {
