...
@Embeddable()
public class MonVContaVerId implements Serializable {

    @Override
    public int hashCode() {
        int hash = 5;
        hash = 37 * hash + Objects.hashCode(this.aaKeyUnitaDoc);
        hash = 37 * hash + Objects.hashCode(this.dtRifConta);
        hash = 37 * hash + Objects.hashCode(this.idRegistroUnitaDoc);
        hash = 37 * hash + Objects.hashCode(this.idStrut);
        hash = 37 * hash + Objects.hashCode(this.idSubStrut);
        hash = 37 * hash + Objects.hashCode(this.idTipoDocPrincipale);
    ...
    public boolean equals(Object obj) {
        ...
        final MonVContaVerId other = (MonVContaVerId) obj;
