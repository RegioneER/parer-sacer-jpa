...
@NamedQuery(name = "MonVLisUniDocDaAnnul.findAll", query = "SELECT m FROM MonVLisUniDocDaAnnul m")
public class MonVLisUniDocDaAnnul implements Serializable {
