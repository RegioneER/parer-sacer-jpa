...
@Embeddable()
public class VrsVUdNonVerId implements Serializable {

    @Override
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.aaKeyUnitaDoc);
        hash = 59 * hash + Objects.hashCode(this.cdKeyUnitaDoc);
        hash = 59 * hash + Objects.hashCode(this.cdRegistroKeyUnitaDoc);
        hash = 59 * hash + Objects.hashCode(this.flNonRisolub);
        hash = 59 * hash + Objects.hashCode(this.flVerif);
    ...
    public boolean equals(Object obj) {
        ...
        final VrsVUdNonVerId other = (VrsVUdNonVerId) obj;
