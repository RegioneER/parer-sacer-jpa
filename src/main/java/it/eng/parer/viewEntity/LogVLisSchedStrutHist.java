 ...
 */
@Entity
@Table(name = "LOG_V_LIS_SCHED_STRUT_HIST")
@NamedQuery(name = "LogVLisSchedStrutHist.findAll", query = "SELECT l FROM LogVLisSchedStrutHist l")
public class LogVLisSchedStrutHist implements Serializable {
    ...
    public LogVLisSchedStrutHist() {/* Hibernate */
    }
