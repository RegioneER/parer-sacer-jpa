 ...
 */
@Entity
@Table(name = "ELV_V_RIC_ELENCO_VERS")
@NamedQuery(name = "ElvVRicElencoVers.findAll", query = "SELECT e FROM ElvVRicElencoVers e")
public class ElvVRicElencoVers implements Serializable {
