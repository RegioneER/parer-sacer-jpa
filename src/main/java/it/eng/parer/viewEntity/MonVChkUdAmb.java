...
@NamedQuery(name = "MonVChkUdAmb.findAll", query = "SELECT m FROM MonVChkUdAmb m")
public class MonVChkUdAmb implements Serializable {
    ...
    private MonVChkUdAmbId monVChkUdAmbId;

    @EmbeddedId
    public MonVChkUdAmbId getMonVChkUdAmbId() {
        return monVChkUdAmbId;
    }

    public void setMonVChkUdAmbId(MonVChkUdAmbId monVChkUdAmbId) {
        this.monVChkUdAmbId = monVChkUdAmbId;
    }

    public MonVChkUdAmb() {/* Hibernate */
    }
