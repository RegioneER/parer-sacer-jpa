...
@Embeddable()
public class MonVContaVersAnnulId implements Serializable {

    @Override
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.aaKeyUnitaDoc);
        hash = 59 * hash + Objects.hashCode(this.dtRifConta);
        hash = 59 * hash + Objects.hashCode(this.idRegistroUnitaDoc);
        hash = 59 * hash + Objects.hashCode(this.idStrut);
        hash = 59 * hash + Objects.hashCode(this.idSubStrut);
        hash = 59 * hash + Objects.hashCode(this.idTipoDocPrincipale);
    ...
    public boolean equals(Object obj) {
        ...
        final MonVContaVersAnnulId other = (MonVContaVersAnnulId) obj;
