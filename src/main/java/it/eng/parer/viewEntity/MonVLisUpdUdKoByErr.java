...
@NamedQuery(name = "MonVLisUpdUdKoByErr.findAll", query = "SELECT m FROM MonVLisUpdUdKoByErr m")
public class MonVLisUpdUdKoByErr implements MonVLisUpdUdKoInterface {
    ...
    public MonVLisUpdUdKoByErr() {/* Hibernate */
    }
