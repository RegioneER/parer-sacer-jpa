 ...
 */
@Entity
@Table(name = "MON_V_LIS_UD_UPD_KO_BY_ERR")
@NamedQuery(name = "MonVLisUdUpdKoByErr.findAll", query = "SELECT m FROM MonVLisUdUpdKoByErr m")
public class MonVLisUdUpdKoByErr implements MonVLisUdUpdKoInterface {
