 ...
 */
@Entity
@Table(name = "LOG_V_LIS_INI_SCHED_JOB_STRUT")
@NamedQuery(name = "LogVLisIniSchedJobStrut.findAll", query = "SELECT l FROM LogVLisIniSchedJobStrut l")
public class LogVLisIniSchedJobStrut implements Serializable {
    ...
    public LogVLisIniSchedJobStrut() {/* Hibernate */
    }
