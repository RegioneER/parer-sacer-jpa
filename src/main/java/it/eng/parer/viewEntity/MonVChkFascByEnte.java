...
@NamedQuery(name = "MonVChkFascByEnte.findByEnteUser", query = "SELECT m FROM MonVChkFascByEnte m WHERE m.idEnte = :idEnte AND m.idUserIam = :idUser")
