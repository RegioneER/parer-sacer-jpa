...
/**
 * The persistent class for the ORG_V_CHK_STRUT_PARTITION_FASC database table.
 *
 */
@Entity
@Table(name = "ORG_V_CHK_STRUT_PARTITION_FASC")
@NamedQuery(name = "OrgVChkStrutPartitionFasc.findAll", query = "SELECT o FROM OrgVChkStrutPartitionFasc o")
public class OrgVChkStrutPartitionFasc implements Serializable {
    ...
    public OrgVChkStrutPartitionFasc() {/* Hibernate */
    }
    ...
    public String getCdPartitionSesfascerr() {
        return this.cdPartitionSesfascerr;
    }
    ...
    public String getFlPartSesfascerrOk() {
        return this.flPartSesfascerrOk;
    }
