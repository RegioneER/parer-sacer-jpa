...
@Embeddable()
public class MonVCntAggEnteId implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 13 * hash + Objects.hashCode(this.tiDtCreazione);
    ...
    public boolean equals(Object obj) {
        ...
        final MonVCntAggEnteId other = (MonVCntAggEnteId) obj;
