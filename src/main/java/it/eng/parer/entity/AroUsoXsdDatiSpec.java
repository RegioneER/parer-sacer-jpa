...
public class AroUsoXsdDatiSpec implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "ARO_USO_XSD_DATI_SPEC_IDUSOXSDDATISPEC_GENERATOR", sequenceName = "SARO_USO_XSD_DATI_SPEC", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ARO_USO_XSD_DATI_SPEC_IDUSOXSDDATISPEC_GENERATOR")
