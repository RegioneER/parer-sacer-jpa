...
public class DecAaRegistroUnitaDoc implements Serializable {
    ...
    private List<DecErrAaRegistroUnitaDoc> decErrAaRegistroUnitaDocs;
    private List<DecWarnAaRegistroUd> decWarnAaRegistroUds;
    private List<DecParteNumeroRegistro> decParteNumeroRegistros;

    public DecAaRegistroUnitaDoc() {
    }

    @Id
    @SequenceGenerator(name = "DEC_AA_REGISTRO_UNITA_DOC_IDAAREGISTROUNITADOC_GENERATOR", sequenceName = "SDEC_AA_REGISTRO_UNITA_DOC", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "DEC_AA_REGISTRO_UNITA_DOC_IDAAREGISTROUNITADOC_GENERATOR")
