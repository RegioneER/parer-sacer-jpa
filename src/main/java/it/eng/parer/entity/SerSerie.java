...
public class SerSerie implements Serializable {
    ...
    private List<SerLinkSerie> serLinkSeriePartenzas;
    private List<SerLinkSerie> serLinkSerieArrivos;
    ...
    @Id
    @SequenceGenerator(name = "SER_SERIE_IDSERIE_GENERATOR", sequenceName = "SSER_SERIE", allocationSize = 1)
